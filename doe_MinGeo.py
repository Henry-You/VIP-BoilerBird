...
#GEOMETRY SWEEP
initSamples = lhs(n=len(geometry_bounds), samples = n_geometries, criterion = "cm", iterations = 1000)
...
#KINEMAITCS SWEEP
sobol_sampler = qmc.Sobol(d=len(kinematic_bounds), scramble=False)
